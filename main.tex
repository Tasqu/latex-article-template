...
%% Declare comment/revision highlights for convenience.
% Optional definitions, can be removed if desired (along with examples in `introduction.tex`).
% To hide the highlights, change the to `\textcolor{black}`.
